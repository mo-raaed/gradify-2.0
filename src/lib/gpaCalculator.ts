/**
 * GPA Calculation Utilities (Client-side)
 * Shared with Convex backend via similar implementation
 */
 ...
 */
export function recalculateAllGPAs(semesters: Semester[]): TranscriptData {
