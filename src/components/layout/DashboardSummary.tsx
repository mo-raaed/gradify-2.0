...
export function DashboardSummary({ semesters, cumulativeGPA, updatedAt }: DashboardSummaryProps) {
  const numberHoverStyles = "inline-block text-foreground tracking-tight [text-shadow:0_0_15px_rgba(73,147,250,0.2)] dark:[text-shadow:0_0_20px_rgba(255,255,255,0.4)] transition-transform duration-300 hover:scale-[1.10] cursor-default origin-center";
      ...
      <div className="rounded-[2rem] bg-card p-8 shadow-2xl border border-border">
        <div className="grid grid-cols-4 max-lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            <p className="text-sm text-primary font-bold uppercase tracking-[0.1em]">
              Earned Credits
            </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg font-bold text-foreground mt-1 opacity-90">
              {getUpdatedAgoText()}
            </p>
          </div>
