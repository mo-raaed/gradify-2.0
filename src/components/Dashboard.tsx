      ...
      <section className="px-12 max-lg:px-8 max-md:px-4 pb-4">
        <div className="flex items-center justify-between gap-4 max-md:flex-col max-md:items-stretch">
          ...
          <div className="flex gap-3 max-md:flex-col">
            <Button
              onClick={() => setIsAddSemesterOpen(true)}
              className="h-10 px-4 max-md:w-full rounded-full bg-card text-primary border border-primary/20 hover:bg-primary/10 transition-colors cursor-pointer"
            >
      ...
      <section className="px-12 max-lg:px-8 max-md:px-4 pb-12 space-y-8">
        ...
        {allSemesters.length === 0 && (
          <div className="text-center py-12">
            ...
            <Button 
              onClick={() => setIsAddSemesterOpen(true)}
              className="rounded-full bg-card text-primary border border-primary/20 hover:bg-primary/10 transition-colors cursor-pointer"
            >
              <Plus className="mr-2 h-4 w-4" />
              Add Semester
            </Button>
